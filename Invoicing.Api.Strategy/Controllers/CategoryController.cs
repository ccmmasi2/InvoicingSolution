...
namespace Invoicing.Api.Strategy.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public void Strategy()
        {
            ...
            //categoria.EstrategiaCrud = new Category.CategoriaCrudEstrategia().
            //categoria.EstrategiaCrud = new CategoryRepository(null).Insert;
            ...
            producto.AplicarEstrategiaCrud(); // Realizará la operación de creación para el producto
